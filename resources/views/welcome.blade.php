                                    ...
                                    <div class="bg-white rounded-md -space-y-px">
                                        ...
                                        <label
                                            ...
                                            <div class="ml-3 flex flex-col">
                                                ...
                                                <span id="in_person-0-label" class="block text-sm font-medium">
                                                    In Person
                                                </span>
                                                <!-- Checked: "text-blue-700", Not Checked: "text-gray-500" -->
                                                <span id="in_person-0-description" class="block text-sm">
                                        ...
                                        <label
                                            ...
                                            <div class="ml-3 flex flex-col">
                                                <!-- Checked: "text-blue-900", Not Checked: "text-gray-900" -->
                                                <span id="in_person-2-label" class="block text-sm font-medium">
                                                    Zoom
                                                </span>
                                                <!-- Checked: "text-blue-700", Not Checked: "text-gray-500" -->
                                                <span id="in_person-2-description" class="block text-sm">
